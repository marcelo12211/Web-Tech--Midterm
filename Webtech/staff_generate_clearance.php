...
<head>
    ...
    <title>Generate Barangay Clearance - Staff</title>
...
<body>
    ...
    <div class="certificate-container cert-card">
        <div class="cert-header">
            ...
            <h1 style="color: #34a853;">BARANGAY CLEARANCE</h1>
            <p style="margin-top: 20px; font-weight: 500;">TO WHOM IT MAY CONCERN:</p>
        </div>
        
        <div class="cert-body">
            <p class="indent">This is to certify that <span class="recipient"><?php echo htmlspecialchars($resident_name); ?></span>, of legal age, Filipino, and a resident of this Barangay, is known to me to be of good moral character.</p>

            <p class="indent">This further certifies that based on the records of this Barangay, the above-mentioned person has no derogatory record or pending case filed against him/her as of this date.</p>
            
            <p class="indent">This clearance is issued upon the request of the aforementioned individual for the purpose of <span class="recipient"><?php echo htmlspecialchars($purpose); ?></span>.</p>
