...
<head>
    ...
    <title>Generate Certificate of Indigency - Staff</title>
    ...
    <style>
        ...
        .cert-header h1 { font-size: 2rem; color: #28a745; margin-bottom: 5px; }
...
<body>
    ...
    <div class="certificate-container cert-card">
        ...
        <div class="cert-body">
            ...
            <p class="indent">The aforementioned person has no sufficient income to support his/her family and is in need of financial assistance.</p>
            
            <p class="indent">This certification is issued upon the request of the aforementioned person for the purpose of <span class="recipient"><?php echo htmlspecialchars($purpose); ?></span>.</p>
