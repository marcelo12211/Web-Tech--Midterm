        ...
        <div class="page-content">
            ...
            <form method="GET" action="staff_documents.php" class="data-control-panel">
                <div class="search-and-filter-wrapper">
                    <input type="text" placeholder="Search by ID or Name..." class="search-input" name="search" value="<?php echo htmlspecialchars($search_term); ?>" />
                            ...
                            <?php else: ?>
                                ...
                                ?>
                                    <tr class="doc-row" data-doc-id="<?php echo $doc_id; ?>">
                                        <td style="padding: 12px;"><?php echo $doc_id; ?></td>
                                        <td><?php echo htmlspecialchars($doc['issued_to']); ?></td>
                                        <td><span class="special-status-bar <?php echo $type_badge['class']; ?>"><?php echo $type_badge['text']; ?></span></td>
                                        <td><?php echo htmlspecialchars($doc['date_issued']); ?></td>
                                        <td><span class="special-status-bar <?php echo $status_badge['class']; ?>"><?php echo $status_badge['text']; ?></span></td>
                                        <td>
                                            <div class="action-icon-group">
                                                <a href="staff_edit_document.php?id=<?php echo $doc_id; ?>" class="action-btn" title="Edit">
                                                    <i class="fas fa-edit"></i> 
                                                </a>
                                                <a href="staff_documents.php?archive_id=<?php echo $doc_id; ?>" 
                                                   class="action-btn delete-btn" 
                                                   onclick="return confirm('Archive document ID: <?php echo $doc_id; ?>?');">
                                        ...
                                        <td colspan="6">
                                            <div class="detail-container">
                                                <div class="detail-tabs">
                                                    <span class="detail-tab active" data-tab="details-<?php echo $doc_id; ?>">Details</span>
                                                    <span class="detail-tab" data-tab="notes-<?php echo $doc_id; ?>">Notes</span>
                                                </div>
                                                <div class="tab-content active" id="details-<?php echo $doc_id; ?>">
                                                    <div class="detail-grid">
                                                        ...
                                                        <div class="detail-box">
                                                            <p><strong>Payment:</strong> <?php echo $doc['is_paid'] ? 'Paid' : 'Unpaid'; ?></p>
                                                            <p><strong>Released By:</strong> <?php echo htmlspecialchars($doc['released_by']); ?></p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="tab-content" id="notes-<?php echo $doc_id; ?>">
                                                    <div class="detail-box">
                                                        <p><em><?php echo htmlspecialchars($doc['note']); ?></em></p>
                                                    </div>
                                                </div>
                                            </div>
                                        </td>
